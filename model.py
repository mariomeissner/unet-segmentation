...
def unet(input_size=(256, 256, 3), activation='relu', pretrained_weights=None,):
    ...
    if activation is None:
      conv1 = KAF(64, D=5, kernel='softplus', conv=True)(conv1)
    ...
    if activation is None:
      conv2 = KAF(128, D=5, kernel='softplus', conv=True)(conv2)
    ...
    if activation is None:
      conv3 = KAF(256, D=5, kernel='softplus', conv=True)(conv3)
    ...
    if activation is None:
      conv4 = KAF(512, D=5, kernel='softplus', conv=True)(conv4)
    ...
    if activation is None:
      conv5 = KAF(1024, D=5, kernel='softplus', conv=True)(conv5)
    ...
    if activation is None:
      conv9 = KAF(3, D=5, kernel='softplus', conv=True)(conv9)
